...
public class Outbound {
     ...
     */
    @JsonProperty("journeyTotalWithCreditCard")
    public Double getJourneyTotalWithCreditCard() {
     ...
     */
    @JsonProperty("journeyTotalWithCreditCard")
    public void setJourneyTotalWithCreditCard(Double journeyTotalWithCreditCard) {
     ...
     */
    @JsonProperty("journeyTotalWithDebitCard")
    public Double getJourneyTotalWithDebitCard() {
     ...
     */
    @JsonProperty("journeyTotalWithDebitCard")
    public void setJourneyTotalWithDebitCard(Double journeyTotalWithDebitCard) {
